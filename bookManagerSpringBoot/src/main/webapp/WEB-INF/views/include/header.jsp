 ...
 -->  
  ...
  <link rel="stylesheet" href="<%= request.getContextPath() %>/resources/css/common.css" />
	<!-- 
	 ...
	 -->
  <link rel="stylesheet" media="screen and (min-aspect-ratio:5/4) " href="<%= request.getContextPath() %>/resources/css/web.css" />
  <link rel="stylesheet" media="screen and (max-aspect-ratio:5/4)" href="<%= request.getContextPath() %>/resources/css/mobile.css" />
