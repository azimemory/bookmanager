...
public class BoardController {
	...
	public ModelAndView boardDetail(int bdIdx)  {
		ModelAndView mav = new ModelAndView();
	...
	public FileSystemResource boardDownload(
		...
		FileSystemResource downFile 
			= new FileSystemResource(Code.UPLOAD_PATH+savePath);
	...
	public ModelAndView boardModifyImpl(
			 Board board
			, @RequestParam List<MultipartFile> files
			, @RequestParam(required = false) List<Integer> rmFiles
			, HttpSession session
			)  {
	...
	public ModelAndView boardDelete( int bdIdx
									, String userId
									,HttpSession session)  {
