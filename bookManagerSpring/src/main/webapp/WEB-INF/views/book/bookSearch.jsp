 ...
 <div class="content">
	<section class="section_book">
		<form class="frm-content" action="<%= request.getContextPath()%>/book/innersearch.do" method="post">
			<div class="box_menu">
				<div>
					<span>검색 결과 내 검색 : </span><input type="text" name="keyword"/>
				</div>
				<div>
					<span>인기순 정렬 : </span><input type="radio" name="orderBy" value="RENT_CNT" checked="checked"/>
				</div>
				<div>
					<span>최근 도서 순 정렬 : </span><input type="radio" name="orderBy" value="REG_DATE"/>
				</div>
				<div>
			...
			<div class="box_book">
				...
				<c:forEach items="${bookList}" var="book" varStatus="status">
					<input type="hidden" value="${book.bIdx}" name="bIdxs"/>
