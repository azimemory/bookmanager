package com.uclass.common.util.file;
...
public class FileUtil {
	...
	public void deleteFile(String path) {
		File file = new File(Code.UPLOAD_PATH + path);
		file.delete();
	}
	...
	private void saveFile(FilePart userFile,FileVo fileVo) throws IOException {
		new File(Code.UPLOAD_PATH+fileVo.getSavePath()).mkdirs();
		//파일을 저장
		File file = new File(Code.UPLOAD_PATH+fileVo.getSavePath()+fileVo.getRenameFileName());
